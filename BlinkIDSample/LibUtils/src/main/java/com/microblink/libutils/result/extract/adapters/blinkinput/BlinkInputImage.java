...
import com.microblink.libutils.result.extract.adapters.Orientation;
import com.microblink.blinkinput.image.Image;

public final class BlinkInputImage implements com.microblink.libutils.result.extract.adapters.Image {
