...
import com.microblink.blinkid.view.viewfinder.quadview.QuadViewAnimationListener;
...
public class DetectorActivity extends Activity implements CameraEventsListener, ScanResultListener, OnSizeChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = MediaStore.Images.Media.insertImage(
                        DetectorActivity.this.getContentResolver(),
                        mShownBitmap,
                        "DetectedImage" + System.currentTimeMillis(),
                        ""
                );
        ...
        // camera overlay
        View overlay = getLayoutInflater().inflate(R.layout.mb_blinkid_default_camera_overlay, null);
